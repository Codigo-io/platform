...
mod instruction_64 {
	...
	fn test_transaction_is_ok() {
		...
		let accounts = vec![
			...
			AccountMeta::new_readonly(validate_data_types_v_0_0_0_info.pubkey(), false),
		];
		...
		create_account(&rpc_client, &fee_payer_info, &validate_data_types_v_0_0_0_info, &program_id, 0);
