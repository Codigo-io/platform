...
mod instruction_59 {
	...
	fn test_transaction_is_ok() {
		...
		let data = ValidateImportsInstruction::Instruction59;
		...
		create_account(&rpc_client, &fee_payer_info, &signer_1_info, &Pubkey::from_str("31j2cdxe2M9b9ZnwuRL6Qm4v5zp9v7WiNZDmP8YGweXm").unwrap(), 1);
