...
mod replace_leaf_article {
	...
	fn test_transaction_is_ok() {
		...
		let previous_leaf: Vec<u8> = Default::default();
		...
		let thumbnail: String = Default::default();
		...
		let data = ValidateStateCompressionInstruction::ReplaceLeafArticle(crate::generated::instructions::ReplaceLeafArticleArgs{
			previous_leaf,
			root,
			index,
			name,
