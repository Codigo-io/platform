...
mod transfer_authority {
	...
	fn test_transaction_is_ok() {
		...
		let new_authority: Pubkey = Pubkey::new_unique();
		...
		let data = ValidateStateCompressionInstruction::TransferAuthority(crate::generated::instructions::TransferAuthorityArgs{
			new_authority,
		});
		let signers = vec![
			&fee_payer_info,
